...
REGISTER_TYPE(RigidModelComponent)

RigidModelComponent::RigidModelComponent()
{
...
void RigidModelComponent::Initialize()
{
...
void RigidModelComponent::Update()
{
...
void RigidModelComponent::Render()
{
	if (animator_)
	{
...
#ifdef _DEBUG
void RigidModelComponent::RenderImGui()
{
...
void RigidModelComponent::Finalize()
{
	ModelComponent::Finalize();
}

nlohmann::json RigidModelComponent::Serialize()
{
...
void RigidModelComponent::Deserialize(const nlohmann::json& jsonData)
{
	ModelComponent::Deserialize(jsonData);
}

void RigidModelComponent::CreateShaders()
{

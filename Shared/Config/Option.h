...
//Volume
	...
	inline constexpr const float BGM_Volume = 0.3f;
	inline constexpr const float AMB_Volume = 0.5f;
	inline constexpr const float SFX_Volume = 1.0f;
	inline constexpr const float UI_Volume = 1.0f;


//BGM
	inline constexpr const char* Main_BGM = "DOB Music_test2";									//Node 생성은(Main_BGM + "_Beat")으로 자동 결정 ex) DOB Music_test2_Beat 
